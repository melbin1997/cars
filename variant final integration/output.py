...
for i in convertibles.keys():
	dict_convertibles={}
	dict_convertibles['Main Car Name'] = convertibles[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in coupe.keys():
	dict_coupe={}
	dict_coupe['Main Car Name'] = coupe[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in hatchback.keys():
	dict_hatchback={}
	mil='fail'
	dict_hatchback['Main Car Name'] = hatchback[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in hybrid.keys():
	dict_hybrid={}
	mil='fail'
	dict_hybrid['Main Car Name'] = hybrid[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in luxury.keys():
	dict_luxury={}
	mil='fail'
	dict_luxury['Main Car Name'] = luxury[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in minivans.keys():
	dict_minivans={}
	mil='fail'
	dict_minivans['Main Car Name'] = minivans[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in muv.keys():
	dict_muv={}
	mil='fail'
	dict_muv['Main Car Name'] = muv[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in sedans.keys():
	dict_sedans={}
	mil='fail'
	dict_sedans['Main Car Name'] = sedans[i]['Review_link'].split('/')[4].replace('_',' ')
...
for i in suv.keys():
	dict_suv={}
	mil='fail'
	dict_suv['Main Car Name'] = suv[i]['Review_link'].split('/')[4].replace('_',' ')
